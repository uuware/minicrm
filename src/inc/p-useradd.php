...
<span style="width:auto;"><label for=rightsviewer>Viewer</label><input type="checkbox"<?php echo $disabled; ?> value="1" class="t-input" style="width:auto;" name="rightsviewer" id="rightsviewer" <?php echo _iif($rightsviewer == '1', 'checked'); ?>></span>
<span style="width:auto;"><label for=rightsbusiness>Business manager</label><input type="checkbox"<?php echo $disabled; ?> value="1" class="t-input" style="width:auto;" name="rightsbusiness" id="rightsbusiness" <?php echo _iif($rightsbusiness == '1', 'checked'); ?>></span>
