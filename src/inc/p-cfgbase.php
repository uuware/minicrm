...
<tr>
<td class="name">
of menu line: <input type="text" class="txtedit" name="backmenu" id="backmenu" value="<?php echo _showhtml($backmenu); ?>" style="width:80px;background-color:<?php echo _showhtml($backmenu); ?>;">
